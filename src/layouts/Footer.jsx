    ...
    const timer = setInterval(() => {
      if (sliderRef.current) {
        ...
        if (
          ...
          sliderRef.current.scrollLeft += lang === "uz" ? 60 : 91;
        }
      }
    }, 2000);
    ...
    <div className="fixed bottom-0 flex px-5 items-end py-3 footer-shadow border-t w-[100%] bg-white  justify-around">
      ...
      >
        <img
          ...
          alt=""
        />
        <span className="text-[12px]">{t("restaurants")}</span>
      </Link>
      <Link
        to="/cart"
      ...
      >
        ...
        <span className="text-[12px] mt-1">{t("footer.basket")}</span>
        <p
      ...
      {pathname.includes("category") ? (
        <div
          ...
          className={`overflow-scroll bg-transparent justify-between ml-1 no-scrollbar flex gap-3 ${
            lang === "uz" ? "w-[65px]" : "gap-[22px] w-[75px]"
          }`}
        >
          <button className="text-gray-500  bg-transparent cursor-pointer flex flex-col items-center justify-end">
            ...
            <span className="text-[12px] mt-1">{t("footer.info")}</span>
          </button>
          <button className="text-gray-500 bg-transparent ml-1 cursor-pointer flex flex-col items-center justify-end">
            ...
            <span className="text-[12px] mt-1">{t("footer.connect")}</span>
          </button>
          <button className="text-gray-500 bg-transparent cursor-pointer flex flex-col items-center justify-end">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="text-[12px] mt-1">{t("footer.instagram")}</span>
          </button>
        </div>
      ) : (
        ""
      ...
      >
        ...
        <span className="text-[12px]">{t("footer.like")}</span>
      </Link>
      <button
      ...
      >
        ...
        <span className="text-[12px]">{t("footer.account")}</span>
      </button>
    </div>
  );
};
